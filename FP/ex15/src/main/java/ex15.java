...
public class ex15 {
    /**
     * Keeps track of the number of primality checks performed thus far.
     */
    private static final AtomicInteger sPrimalityCheckCounter =
        new AtomicInteger();
    ...
    public static Runnable makeRunnable(int integer) {
        ...
        return () -> {
            ...
            // primality.
            if (Options.instance()
                .printDiagnostic(sPrimalityCheckCounter.getAndIncrement())) {
                if (result == 0)
